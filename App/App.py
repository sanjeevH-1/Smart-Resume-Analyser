# Developed by Sanjeev Hanchinal    Made with Streamlit
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="#" style="text-decoration: none; color: #021659;">Sanjeev Hanchinal</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="#" style="text-decoration: none; color: grey;">Sanjeev Hanchinal</a> through 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Sanjeev ! Total %d " % values + " User's Have Used Our Tool : )")                
